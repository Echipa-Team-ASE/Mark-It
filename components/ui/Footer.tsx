...
function FooterSocialLinks() {
    return (
        <div className="flex gap-2 my-2 items-center space-x-2">
            <Link href="https://www.facebook.com/markitphera" target="_blank">
            ...
            <Link href="https://www.twitter.com/markitphera" target="_blank">
            ...
            <Link href="https://www.instagram.com/markitphera" target="_blank">
            ...
            <Link href="https://www.linkedin.com/company/markitphera" target="_blank">
        ...
        <footer className="mx-auto max-w-7xl mb-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
                <div className="text-xs py-3 text-gray-400 ml-6">
                    &copy; Copyright {new Date().getFullYear()} markitphera. All rights reserved.
                </div>
